# Copilot Instructions — Example (used by Exercise 6)

> This is an **example** custom-instructions file that ships with the course so
> you have something to reference in Exercise 6. When you do Exercise 6, you'll
...
> named `.example.md` on purpose so it does **not** auto-apply — Exercise 6 is
